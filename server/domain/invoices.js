...
function buildInvoiceDto(payment = {}, booking = {}) {
  ...
  return {
    ...
    promotionDiscountType: normalized.promoDiscountType || "",
    promotionDiscountValue: Number(normalized.promoDiscountValue || normalized.promoDiscountPercent || 0),
    reward: normalized.rewardName || "",
    rewardCode: normalized.rewardClaimCode || "",
    rewardDiscountType: normalized.rewardDiscountType || "",
    rewardDiscountValue: normalized.rewardValue || "",
    promoDiscountAmount,
